<template>
	...
	<!-- 
				<ul class="nav navbar-top-links pull-left">
				  <li class=""> <a class="" href="index.html">主页 </a> </li>
				  <li class="dropdown"> 
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 学院 </a>
					<div class="dropdown-menu dropdown-menu-md with-arrow" >
					  <a class="dropdown-item" href="#">社团</a>
					  <a class="dropdown-item" href="#">竞赛</a>
					  <a class="dropdown-item" href="#">活动</a>
					</div>
				  </li>
				   <li class=""> <a class="" href="#">科目</a> </li>
				   <li class=""> <a class="" href="#">胜地</a> </li>
				   <li class=""> <a class="" href="#">美食</a> </li>
				</ul>			 -->			
	            ...
	            <ul class="nav navbar-top-links pull-right">
	                ...
	                <li id="dropdown-user" class="dropdown">
	                    <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
	                        ...
	                        <div class="username hidden-xs">唐宁</div>
	                    </a>
